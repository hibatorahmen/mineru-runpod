...
- **`vlm-auto-engine`** (default): trained primarily on English + Chinese PDFs. Best for **PDF**. For **images of text**, especially non-Latin scripts, prefer `pipeline`.
...
|---|---|
| `east_slavic` | Russian, Ukrainian, Belarusian |
| `cyrillic` | Serbian, Bulgarian, Macedonian, Mongolian (non-Slavic Cyrillic) |
| `latin` | French, German, Spanish, Polish, Vietnamese, Indonesian, etc. |
...
| `ch`, `ch_server`, `ch_lite`, `en` | Variants of Chinese / English defaults |
