...
If this saved you a debugging session, the easiest way to say thanks is [signing up for RunPod through this link](https://runpod.io?ref=31jdfpnq). Star the [repo on GitHub](https://github.com/sergeyshmakov/mineru-runpod) for updates.

* * *
<small><strong>Disclosure:</strong> the RunPod link above uses a referral code that credits me at no cost to you. The post would read the same without it.</small>
